...
<title>My JSP 'privateletter_list.jsp' starting page</title>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/scripts/backstage/privateletter/privateletter_init.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath }/scripts/jeasyui/custom-je.js"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/styles/backstage/privateletter/privateletter_style.css">
...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<div id="tb" style="padding:5px;height:auto">
			<div>
				&nbsp;私信状态:<input id="s_infostatus" style="width: 80px;">&nbsp;&nbsp;
				发私信用户邮箱:<input id="s_susers_email" panelHeight="auto" style="width: 100px;">&nbsp;&nbsp; 
				收私信用户邮箱:<input id="s_reusers_email" panelHeight="auto" style="width: 100px;">&nbsp;&nbsp; 
				私信内容:<input id="s_info" panelHeight="auto" style="width: 100px;">&nbsp;&nbsp;&nbsp;
