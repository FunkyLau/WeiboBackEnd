...
<body>
	...
	<div id="bankImages">
		...
		<c:forEach var="pictures" items="${ userPicList }">
		  <c:forEach var="url" items="${ pictures.picturesUrl }">
			<img alt=""
				src="${ pageContext.request.contextPath }/uploadImages${ pictures.picturesUrl }">
		</c:forEach>
		</c:forEach>
	</div>
