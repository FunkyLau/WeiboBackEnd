...
public interface BaseDao {
	...
	/**
	 * 获取指定开始位置到指定结束位置的实体数据，并按照传递的参数排序
	 * @param clazz
	 * @param from
	 * @param size
	 * @param order
	 ...
	 * 
	 */
	public List getObjects(final Class clazz,final String whereSql,final int from,final int size,final String order,final String sort);
	/**
	 * 获取带有查询条件的实体对象数据的总数
	 * @param clazz
	 * @param whereSql
